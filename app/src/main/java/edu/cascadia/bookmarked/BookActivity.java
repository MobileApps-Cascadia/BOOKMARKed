...
public class BookActivity extends AppCompatActivity {
    ...
    private final static String addABookURI = "bookmarked/menu_book/addbook";
    private final static String addABookForSaleURI = "bookmarked/menu_book/addbookforsale";
    ...
    private void initActivity() {
        ...
        // set the proper text on the button
        //Button btnSave = (Button) findViewById(R.id.btnAddOrEdit);
        //btnSave.setText("Save and post menu_book for sale");
    }
